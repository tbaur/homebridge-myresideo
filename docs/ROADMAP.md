...
- Project foundation: strict TypeScript, ESLint flat config, Jest + coverage, PR CI matrix, automated release-please + OIDC publishing workflow (see [`RELEASING.md`](../RELEASING.md)), Apache-2.0 license.
